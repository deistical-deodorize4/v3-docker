...
**FileBrowser:** first login uses `admin` / `admin` — change it right after (Settings → Profile). The `files/` folder is served as the main source and the hub's `pi02w-hub` folder is read-only.
